...
class ProductFilterRepository
{
    ...
    /**
     * @var \App\Model\Product\Filter\ParameterFilterRepository
     */
    protected $parameterFilterRepository;

    /**
     * @param \App\Component\Doctrine\QueryBuilderExtender $queryBuilderExtender
     * @param \App\Model\Product\Filter\ParameterFilterRepository $parameterFilterRepository
     */
    ...
    /**
     * @param \Doctrine\ORM\QueryBuilder $productsQueryBuilder
     * @param \App\Component\Money\Money|null $minimalPrice
     * @param \App\Component\Money\Money|null $maximalPrice
     * @param \App\Model\Pricing\Group\PricingGroup $pricingGroup
     */
