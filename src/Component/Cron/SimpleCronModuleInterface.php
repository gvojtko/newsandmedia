 ...
 *
 * In order for your CRON module to be run you must register it as a service tagged as "instructormap.cron".
 ...
 * taking tasks @see \App\Component\Cron\IteratedCronModuleInterface.
 */
