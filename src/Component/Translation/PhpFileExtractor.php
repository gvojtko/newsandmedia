...
use App\Component\Translation\Exception\ExtractionException;
use App\Component\Translation\Exception\MessageIdArgumentNotPresent;
use SplFileInfo;
use Twig_Node;
...
class PhpFileExtractor implements FileVisitorInterface, NodeVisitor
{
    ...
    /**
     * @var \App\Component\Translation\TransMethodSpecification[]
     */
     ...
     * @param \App\Component\Translation\TransMethodSpecification[] $transMethodSpecifications
     */
