...
use App\Component\FileUpload\Exception\MoveToEntityFailedException;
use App\Component\FileUpload\Exception\UploadFailedException;
...
class FileUpload
{
    ...
    /**
     * @var \App\Component\FileUpload\FileNamingConvention
     */
    ...
    /**
     * @param \App\Component\FileUpload\EntityFileUploadInterface $entity
     */
    ...
    public function postFlushEntity(EntityFileUploadInterface $entity)
    {
        ...
        /** @var \App\Component\FileUpload\FileForUpload $fileForUpload */
