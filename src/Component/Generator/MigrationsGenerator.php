...
use App\Component\Doctrine\Migrations\MigrationsLocation;
use App\Component\Generator\GeneratorResult;
use SqlFormatter;
...
class MigrationsGenerator
{
     ...
     * @param \App\Component\Doctrine\Migrations\MigrationsLocation $migrationsLocation
     * @return \App\Component\Generator\GeneratorResult
     */
    public function generate(array $sqlCommands, \App\Component\Doctrine\Migrations\MigrationsLocation $migrationsLocation)
    {
        ...
        $migrationFileRawData = $this->twigEnvironment->render('Migration/migration.php.twig', [
    ...
    /**
     * @param \App\Component\Doctrine\Migrations\MigrationsLocation $migrationLocation
     */
